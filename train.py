    ...
    def train(self):
        ...
        while iter < cfg.FLAGS.max_iters + 1:
            ...
            if iter % 2 == 0:
                ...
                tf_summary.value.add(tag = 'total_loss', simple_value = float(total_loss))
                tf_summary.value.add(tag = 'rpn_loss_cls', simple_value = float(rpn_loss_cls))
                tf_summary.value.add(tag = 'rpn_loss_box', simple_value = float(rpn_loss_box))
                tf_summary.value.add(tag = 'loss_cls', simple_value = float(loss_cls))
                tf_summary.value.add(tag = 'loss_box', simple_value = float(loss_box))
